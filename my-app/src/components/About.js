      ...
      <Row>
        ...
        <Col className="mt-4">
          <Card.Body className="my-lg-3 col-9 col-md-12 col-sm-12 my-sm-0 w-100">
            ...
            <Card.Text>
              My name is Travis Saucedo, and I'm a Full Stack Web Developer (in
              training) based in San Antonio, TX. When i'm not practicing my
              skills in Full Stack you can find me helping build PC's, traveling
              with my wife or taking my cats on adventures. Check out some of my
              work in my Portfolio, take a look at my Resume and shoot me an
              email!
            </Card.Text>
          </Card.Body>
        </Col>
